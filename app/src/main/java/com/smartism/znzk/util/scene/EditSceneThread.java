...
public class EditSceneThread implements Runnable {
    ...
    public EditSceneThread(ActivityParentActivity context, AddSceneInfo info, Handler defaultHandler) {
    ...
    public void run() {
        {
            ...
            String result = HttpRequestUtils
                    .requestoOkHttpPost(server + "/jdm/s3/scenes/update", pJsonObject, context);
            ...
            if ("0".equals(result)) {
                defaultHandler.post(new Runnable() {
                    ...
                    public void run() {
                       //s();
                        ...
                        Toast.makeText(context, context.getString(R.string.activity_editscene_modify_success),
                ...
                defaultHandler.post(new Runnable() {
                    ...
                    public void run() {
                       //s();
                        context.cancelInProgress();
                        Toast.makeText(context, context.getString(R.string.activity_editscene_not),
                                Toast.LENGTH_LONG).show();
                    }
                });
            }
