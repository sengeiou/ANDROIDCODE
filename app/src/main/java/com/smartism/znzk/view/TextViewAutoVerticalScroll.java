 ...
 * 自动垂直滚动的TextView
 */
public class TextViewAutoVerticalScroll extends TextSwitcher implements ViewSwitcher.ViewFactory {
    ...
    public TextViewAutoVerticalScroll(Context context) {
        this(context, null);
    }

    public TextViewAutoVerticalScroll(Context context, AttributeSet attrs) {
        super(context, attrs);
