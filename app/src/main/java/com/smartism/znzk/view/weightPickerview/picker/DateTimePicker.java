...
import com.smartism.znzk.view.weightPickerview.util.DateUtils;
...
public class DateTimePicker extends WheelPicker {
    ...
    public void setSelectedItem(int year, int month, int day, int hour, int minute) {
        ...
        selectedHour = hour<10 ? "0"+String.valueOf(hour): String.valueOf(hour);
        selectedMinute = minute<10 ? "0"+String.valueOf(minute): String.valueOf(minute);
    }
