...
//        initClickListener();
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            roundColor = a.getColor(R.styleable.MyRoundProcess_myroundColor, getResources().getColor(android.R.color.darker_gray));
            roundProgressColor = a.getColor(R.styleable.MyRoundProcess_myroundProgressColor, getResources().getColor(android.R.color.holo_red_dark));
            textColor = a.getColor(R.styleable.MyRoundProcess_mytextColor, getResources().getColor(android.R.color.holo_blue_dark));
            textSize = a.getDimension(R.styleable.MyRoundProcess_mytextSize, 22f);
