package com.smartism.znzk.view.pickerview.lib;
...
import com.smartism.znzk.view.pickerview.adapter.WheelAdapter;
import com.smartism.znzk.view.pickerview.listener.OnItemSelectedListener;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if(attrs != null) {
            ...
            textSize = a.getDimensionPixelOffset(R.styleable.jdm_textSize,textSize);
        }
