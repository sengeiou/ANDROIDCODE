package com.smartism.znzk.view.alertview;
...
public class AlertView {
    ...
    public AlertView(CharSequence title, CharSequence msg, String cancel, String[] destructive, String[] others, Context context, Style style, OnItemClickListener onItemClickListener) {
     ...
     * 获取数据
     */
    protected void initData(CharSequence title, CharSequence msg, String cancel, String[] destructive, String[] others) {
    ...
    protected void initHeaderView(ViewGroup viewGroup) {
        ...
        if (title != null) {
            ...
            LinearLayout.LayoutParams p = (LinearLayout.LayoutParams) tvAlertMsg.getLayoutParams();
            p.topMargin = (int) contextWeak.get().getResources().getDimension(R.dimen.marginBottom_alert_msg);
            tvAlertMsg.setLayoutParams(p);
        }
        if (msg != null) {
...
//            tvAlert.setTypeface(Typeface.DEFAULT_BOLD);
    ...
    public void dismiss() {
        ...
        decorView.onFinishTemporaryDetach();
