...
public class TtsSpeechActivity extends AppCompatActivity implements View.OnClickListener{
    private static String TAG = TtsSpeechActivity.class.getSimpleName();
    // 语音合成对象
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.tts_play).setOnClickListener(TtsSpeechActivity.this);
        // 初始化合成对象
        mTts = SpeechSynthesizer.createSynthesizer(TtsSpeechActivity.this, mTtsInitListener);
...
//        mCloudVoicersValue = getResources().getStringArray(R.array.voicer_cloud_values);
        ...
        mInstaller = new  ApkInstaller(TtsSpeechActivity.this);
    }
