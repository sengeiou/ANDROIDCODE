...
@SuppressLint("NewApi")
public class AddZhujiOldActivity extends ActivityParentActivity implements OnClickListener, OnItemClickListener {
...
//					Toast.makeText(AddZhujiOldActivity.this, getString(R.string.activity_add_zhuji_nozhu_again), Toast.LENGTH_LONG).show();
                    if (mAlertViewExt != null){
                        mAlertViewExt.dismiss();
                    }
                    mAlertViewExt = new AlertView(getString(R.string.tips), getString(R.string.activity_add_zhuji_idzhu_nofondinwifi), getString(R.string.cancel), new String[]{getString(R.string.sure)}, null, AddZhujiOldActivity.this, Style.Alert.Alert, new OnItemClickListener() {
                        ...
                        public void onItemClick(Object o, int position) {
                            if (position != -1) {
                                mHandler.postDelayed(new Runnable() {
                                    @Override
                                    public void run() {
                                        addZhujiBySerial();//要等这个销毁之后才能再弹出一个 不然会崩溃
                                    }
                                },500);
                            }
                        }
                ...
                if (intent.getIntExtra("data", 1000000) == 0) { //完成主机搜索
                    dismissProgressDialogSearchZhuji();
                    finish();
                    Toast.makeText(AddZhujiOldActivity.this, getString(R.string.activity_add_zhuji_havezhu_addsuccess),
                    ...
                    String message = "";
                    if (!MainApplication.app.getAppGlobalConfig().getVersion().equals(VersionType.CHANNEL_FSNY)) {
                        if (count > 1) {
...
//                        message = getString(R.string.qwq_share);
                        message = "Hub in use. Please contact host to share hub";
                    }
                    if (!tips_isshowing) {
                        tips_isshowing = true;
                        new AlertView(getString(R.string.activity_add_zhuji_nozhu_typetitle),
                                message,
                                null, new String[]{getString(R.string.sure)}, null, AddZhujiOldActivity.this, Style.Alert, new OnItemClickListener() {
    ...
    private Handler.Callback mCallback = new Handler.Callback() {
        ...
        public boolean handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 2:
                    Toast.makeText(getApplicationContext(), getString(R.string.add_shoudong_failed_chaoshi), Toast.LENGTH_LONG).show();
                    break;
                case 3:
                    Toast.makeText(getApplicationContext(), getString(R.string.add_auto_tips_auto_over), Toast.LENGTH_LONG).show();
                    break;
                case 4:
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 3333 && resultCode == Constant.CAPUTRE_ADDRESULT) {
            ...
            finishWifi = true;
            showProgressDialogSearchZhuji();
        } else if (requestCode == 3333 && resultCode == 10000) {
            //扫码添加成功后销毁addHubActivity
            finish();
        }
    }
        ...
        switch (v.getId()) {
            ...
            case R.id.wifizhuji_layout:
                if (finishWifi) {
                    ...
                    intent = new Intent();
                    if (VersionType.CHANNEL_WOAIJIA.equals(MainApplication.app.getAppGlobalConfig().getVersion())) {
//                        intent.setClass(getApplicationContext(), AddZhuJiGuideActivity.class);
                    ...
                    } else if (VersionType.CHANNEL_ZNZK.equals(MainApplication.app.getAppGlobalConfig().getVersion())) {
        ...
        public void run() {
            ...
            if ("-3".equals(result)) {
                defaultHandler.post(new Runnable() {
                    ...
                    public void run() {
                        cancelInProgress();
                        Toast.makeText(AddZhujiOldActivity.this, getString(R.string.activity_add_zhuji_havezhu_shixiao), Toast.LENGTH_LONG).show();
                    }
                });
                ...
                defaultHandler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        finish();
                        Toast.makeText(AddZhujiOldActivity.this, getString(R.string.activity_add_zhuji_havezhu_addsuccess), Toast.LENGTH_LONG).show();
                    }
                });
            }
        }
...
//                Toast.makeText(this, getString(R.string.activity_add_zhuji_idzhu_leng), Toast.LENGTH_SHORT).show();
//            }
            else {
...
//            String result = HttpRequestUtils.requestHttpServer( server + "/jdm/service/find?v=" + URLEncoder.encode(SecurityUtil.crypt(pJsonObject.toJSONString())), AddZhujiOldActivity.this, defaultHandler);
            String result = HttpRequestUtils.requestoOkHttpPost(server + "/jdm/s3/d/find", pJsonObject, AddZhujiOldActivity.this);
            if (result != null && result.startsWith("-3")) {
                ...
                defaultHandler.post(new Runnable() {
                    ...
                    public void run() {
                        cancelInProgress();
                        new AlertView(getString(R.string.tips), sqr, null, new String[]{getString(R.string.sure)}, null, AddZhujiOldActivity.this, Style.Alert, new OnItemClickListener() {
                ...
                defaultHandler.post(new Runnable() {
                    ...
                    public void run() {
                        cancelInProgress();
                        Toast.makeText(AddZhujiOldActivity.this, getString(R.string.activity_add_zhuji_idzhu_notfond), Toast.LENGTH_LONG).show();
                    }
                });
                ...
                defaultHandler.post(new Runnable() {
                    ...
                    public void run() {
                        cancelInProgress();
                        Toast.makeText(AddZhujiOldActivity.this, getString(R.string.activity_add_zhuji_idzhu_offline), Toast.LENGTH_LONG).show();
                    }
                });
            } else if ("0".equals(result)) {
                defaultHandler.post(new Runnable() {
                ...
                defaultHandler.post(new Runnable() {
                    ...
                    public void run() {
                        cancelInProgress();
                        Toast.makeText(AddZhujiOldActivity.this, getString(R.string.net_error_operationfailed), Toast.LENGTH_LONG).show();
                    }
                });
            }
        }
