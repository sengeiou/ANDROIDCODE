package com.smartism.znzk.xiongmai.devices.tour.model;
...
import com.smartism.znzk.xiongmai.devices.tour.model.bean.ConfigGetPreset;
...
//                ,0);
    ...
    public void controlPreset(String cmd, int chn, int presetId, TourCallback callback) {
        ...
        if(cmd == OPPTZControlBean.SET_PRESET){
            bean.Parameter.PresetName = "预置点" + presetId;
        }
        bean.Parameter.Preset = presetId;
                ...
                switch (ex.str) {
                    case PTZTourBean.JSON_NAME:  //处理“获取巡航线”
                        ...
                        try {
                            ...
                            if (listeners.get(PTZTourBean.JSON_NAME) != null) {
                                listeners.get(PTZTourBean.JSON_NAME).onError(null, null, context.getString(R.string.net_error_exception));
                            }
                        }
                    ...
                    case TimimgPtzTourBean.JSON_NAME:
                        ...
                        try {
                            ...
                            if (listeners.get(TimimgPtzTourBean.JSON_NAME) != null) {
                                listeners.get(TimimgPtzTourBean.JSON_NAME).onError(null, null, context.getString(R.string.net_error_exception));
                            }
                        }
                        break;
                    case DetectTrackBean.JSON_NAME:
                        ...
                        try {
                            ...
                            if (listeners.get(DetectTrackBean.JSON_NAME) != null) {
                                listeners.get(DetectTrackBean.JSON_NAME).onError(null, null, context.getString(R.string.net_error_exception));
                            }
                        }
                        break;
                }
