...
import com.smartism.znzk.xiongmai.lib.funsdk.support.config.AlarmInfo;
import com.smartism.znzk.xiongmai.lib.funsdk.support.config.BaseConfig;
import com.smartism.znzk.xiongmai.lib.funsdk.support.config.DevCmdGeneral;
import com.smartism.znzk.xiongmai.lib.funsdk.support.config.DevCmdOPFileQueryJP;
import com.smartism.znzk.xiongmai.lib.funsdk.support.config.DevCmdOPRemoveFileJP;
import com.smartism.znzk.xiongmai.lib.funsdk.support.config.DevCmdOPSCalendar;
import com.smartism.znzk.xiongmai.lib.funsdk.support.config.DevCmdSearchFileNumJP;
...
import com.smartism.znzk.xiongmai.lib.funsdk.support.config.SameDayPicInfo;
...
import com.smartism.znzk.xiongmai.lib.funsdk.support.models.FunDeviceBuilder;
import com.smartism.znzk.xiongmai.lib.funsdk.support.models.FunLoginType;
import com.smartism.znzk.xiongmai.lib.funsdk.support.utils.DeviceWifiManager;
import com.smartism.znzk.xiongmai.lib.funsdk.support.utils.MyUtils;
import com.smartism.znzk.xiongmai.lib.funsdk.support.utils.SharedParamMng;
import com.smartism.znzk.xiongmai.lib.funsdk.support.utils.StringUtils;
import com.smartism.znzk.xiongmai.lib.sdk.bean.DownloadInfo;
...
import com.smartism.znzk.xiongmai.lib.sdk.struct.ManualSnapModeJP;
import com.smartism.znzk.xiongmai.lib.sdk.struct.OPRemoveFileJP;
import com.smartism.znzk.xiongmai.lib.sdk.struct.SDBDeviceInfo;
import com.smartism.znzk.xiongmai.lib.sdk.struct.SDK_Authority;
...
import com.smartism.znzk.xiongmai.lib.sdk.struct.SDK_TitleDot;
import com.smartism.znzk.xiongmai.lib.sdk.struct.SInitParam;
...
public class FunSupport implements IFunSDKResult {
    ...
    private  String APP_UUID = "e0534f3240274897821a126be19b6d46";
    private  String APP_KEY = "0621ef206a1d4cafbe0c5545c3882ea8";
    private  String APP_SECRET = "90f8bc17be2a425db6068c749dee4f5d";
    ...
    public static synchronized void setInstance(FunSupport support){
        support = mInstance ;
    }

    public void init(Context context) {
        MainApplication temp = (MainApplication) context;
        APP_UUID = temp.getAppGlobalConfig().getXMAPPUUID() ;
        APP_SECRET= temp.getAppGlobalConfig().getXMAPPSecret();
        APP_KEY = temp.getAppGlobalConfig().getXMAPPKey();
...
//			mDeviceGetConfigQueue.add(new DeviceGetConfig(funDevice, configName));
    ...
    public  void mpsInit(String value){
        String pushToken = MyUtils.getMpsPushToken(getContext());
        String address = "Third:"+value;
        SMCInitInfo info = new SMCInitInfo();
        G.SetValue(info.st_0_user, mLoginUserName);
        G.SetValue(info.st_1_password, mLoginPassword);
        G.SetValue(info.st_2_token, pushToken);
        G.SetValue(info.st_5_appType,address);
        MpsClient.Init(getHandler(), G.ObjToBytes(info), 0);
    }
    ...
    public void mpsLinkDevice(FunDevice funDevice) {
        if (null != funDevice) {
          int result =   MpsClient.LinkDev(getHandler(),
                    funDevice.getDevSn(),
...
//					}
            ...
            {
                FunLog.i(TAG, "EUIMSG.MC_LinkDev"+msg.arg1);
            }
            break;
            case EUIMSG.MC_UnlinkDev: // 解除报警关联
            {
                FunLog.i(TAG, "EUIMSG.MC_UnlinkDev"+msg.arg1);
            }
            break;
            ...
            case EUIMSG.DEV_WAKEUP:
                if(msg.arg1>=0){
                    for (OnFunListener l : mListeners) {
                        if (l instanceof OnFunDeviceOptListener) {
                            ((OnFunDeviceOptListener) l).onDoorBellWakeUp();
                        }
                    }
                }
                break;
