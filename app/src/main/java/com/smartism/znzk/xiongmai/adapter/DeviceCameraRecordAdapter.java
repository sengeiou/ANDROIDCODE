...
public class DeviceCameraRecordAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if ( mPlayingIndex == position ) {
        	viewHolder.tvRecordTime.setTextColor(mContext.getResources().getColor(R.color.zhzj_default));
        } else {
        	viewHolder.tvRecordTime.setTextColor(mContext.getResources().getColor(R.color.gray));
        }
